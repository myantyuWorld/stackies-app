  ...
  <div class="bg-gradient-to-br ">
    ...
    <div class="flex p-5">
      <div class="w-1/4 pt-8 pl-4  rounded-xl shadow-lg">
        <ol class="relative m-4 text-gray-500 border-l border-gray-200 dark:border-gray-700 dark:text-gray-400">
          <li class="mb-10 ml-6">
            <span
            ...
            <h3 class="font-medium leading-tight">
              <RouterLink to="/master">経験技術の登録</RouterLink></h3>
            <p class="text-sm">経験のある言語、ツールを選択し、登録ボタンをクリック</p>
          </li>
          ...
          <li class="mb-10 ml-6">
            ...
            <h3 class="font-medium leading-tight">
              <RouterLink to="/register">基本能力の登録</RouterLink></h3>
            <p class="text-sm">あなたの経歴概要と、「経験技術の登録」で選択した技術のレベルを選択し、登録ボタンをクリック</p>
          </li>
          <li class="ml-6">
            <span
              class="absolute flex items-center justify-center w-8 h-8 bg-gray-100 rounded-full -left-4 ring-4 ring-white dark:ring-gray-900 dark:bg-gray-700">
            ...
            <h3 class="font-medium leading-tight">
              <RouterLink to="/projects">案件対応履歴の表示</RouterLink></h3>
